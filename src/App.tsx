...
const App = () => {
  ...
  // Google OAuth wrapper - always enable with proper client ID
  const GoogleAuthWrapper = ({ children }: { children: React.ReactNode }) => {
    const clientId = import.meta.env.VITE_GOOGLE_CLIENT_ID || "246004709667-1a33cbkt2b2hq2m1foav1b3j4fsvilef.apps.googleusercontent.com";
