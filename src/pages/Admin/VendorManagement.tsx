...
import { Search, Store, Eye, Check, X, Pause, Play, Filter, Download, RefreshCw, Users, Star, Plus, Edit } from 'lucide-react';
...
import { getAllVendors, updateVendorStatus, getVendorById, createVendor, updateVendorById } from '@/services/vendorService';
  ...
  const handleVendorFormSubmit = async (data: any) => {
    try {
      if (isEditMode && selectedVendor) {
        await updateVendorById(selectedVendor._id, data);
        toast({
          title: "Success",
          ...
          <DialogHeader>
            ...
            <DialogDescription>
              {isEditMode 
                ...
                : 'Create a new vendor account with full details'
              }
            </DialogDescription>
          </DialogHeader>
          <VendorForm
