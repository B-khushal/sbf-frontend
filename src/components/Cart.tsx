...
const Cart = ({ 
  ...
  return (
    <>
      ...
      <div 
        className={cn(
          "fixed top-0 right-0 bottom-0 w-full sm:w-96 bg-background shadow-lg z-50 flex flex-col transition-transform duration-500 ease-out-expo",
      ...
      >
        ...
        {items.length > 0 && (
          <div className="border-t py-4 px-6">
            ...
            <button 
              className="w-full h-12 bg-primary text-primary-foreground flex items-center justify-center hover-lift subtle-shadow"
