                  ...
                  <AnimatePresence>
                    {showUserMenu && (
                      <motion.div
                        ...
                        className="absolute right-0 top-full mt-2 w-56 bg-white rounded-xl shadow-xl border border-gray-100 p-2 z-dropdown will-change-transform dropdown-responsive"
                        style={{ 
                      ...
                      >
                        ...
                        <div className="py-1">
                          <Link to="/profile" className="flex items-center w-full px-3 py-2.5 text-sm text-gray-700 hover:bg-gray-100 rounded-md transition-all duration-200">
                            <div className="flex items-center justify-center w-5 h-5 mr-3">
                              <User className="w-4 h-4" />
                            </div>
                            <span>My Account</span>
                          </Link>
                          <Link to="/profile#orders" className="flex items-center w-full px-3 py-2.5 text-sm text-gray-700 hover:bg-gray-100 rounded-md transition-all duration-200">
                            <div className="flex items-center justify-center w-5 h-5 mr-3">
                          ...
                          {user.role === 'admin' && (
                            <Link to="/admin" className="flex items-center w-full px-3 py-2.5 text-sm text-gray-700 hover:bg-gray-100 rounded-md transition-all duration-200">
                              <div className="flex items-center justify-center w-5 h-5 mr-3">
                          ...
                          {user.role === 'vendor' && (
                            <Link to="/vendor/dashboard" className="flex items-center w-full px-3 py-2.5 text-sm text-gray-700 hover:bg-gray-100 rounded-md transition-all duration-200">
                              <div className="flex items-center justify-center w-5 h-5 mr-3">
                                <Store className="w-4 h-4" />
                              </div>
                          ...
                          <button
                            ...
                            className="flex items-center w-full px-3 py-2.5 text-sm text-red-600 hover:bg-red-50 rounded-md transition-all duration-200"
                          >
                            <div className="flex items-center justify-center w-5 h-5 mr-3">
