...
export const IS_DEV_MODE = import.meta.env.MODE === 'development' || import.meta.env.DEV;
export const ENABLE_PAYMENT = import.meta.env.VITE_ENABLE_PAYMENT === 'true';
export const MOCK_PAYMENT = import.meta.env.VITE_MOCK_PAYMENT !== 'false'; // Default to true
export const ENABLE_ANALYTICS = import.meta.env.VITE_ENABLE_ANALYTICS === 'true';
export const ENABLE_EMAIL = import.meta.env.VITE_ENABLE_EMAIL === 'true';
export const DEV_LOGGING = import.meta.env.VITE_DEV_LOGGING !== 'false'; // Default to true
...
if (DEV_LOGGING) {
  ...
  console.log('  Payment:', ENABLE_PAYMENT ? 'Enabled' : MOCK_PAYMENT ? 'Mocked' : 'Disabled');
  console.log('  Analytics:', ENABLE_ANALYTICS ? 'Enabled' : 'Disabled');
  console.log('  Email:', ENABLE_EMAIL ? 'Enabled' : 'Disabled');
}
