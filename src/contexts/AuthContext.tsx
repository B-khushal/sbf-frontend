...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    // Throttle auth check to prevent infinite loops
    ...
    const handleStorageChange = (event: StorageEvent) => {
      // React to relevant auth changes, but throttle to avoid loops
    ...
    // Don't listen to custom storageUpdate events to avoid loops
